...
values."
  (setq-default
   ...
   ;; listed in `dotspacemacs-configuration-layers'. `nil' disable importthe lazy
   ...
   '(
     ...
     spell-checking
     ;;syntax-checking
     ;;(sytax-checking :variables flycheck-scalastylerc (expand-file-name "~/scalastyle_config.xml"))
     version-control
     scala
